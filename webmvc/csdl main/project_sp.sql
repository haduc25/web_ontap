...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2222787783ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_sp&table=tbl_sanpham">`project_sp`.`tbl_sanpham`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_sp&table=tbl_nhasx">`project_sp`.`tbl_nhasx`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clothes_shop&table=news">`clothes_shop`.`news`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clothes_shop&table=products">`clothes_shop`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clothes_shop&table=users">`clothes_shop`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_sp2&table=tbl_sanpham">`project_sp2`.`tbl_sanpham`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_sp2&table=thl_nhasx">`project_sp2`.`thl_nhasx`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hocsinh&table=sinhvien">`hocsinh`.`sinhvien`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="576c2226605b494e3a48292a5b327c45">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="project_sp" targettable="tbl_nhasx">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_nhasx`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="project_sp" targettable="tbl_sanpham">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_sanpham`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="project_sp" targettable="tbl_sanpham">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="clothes_shop" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="clothes_shop" targettable="news">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `news`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="clothes_shop" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="clothes_shop" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
